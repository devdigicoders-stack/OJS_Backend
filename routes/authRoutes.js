...
import { login, getProfile, updateProfile, changePassword, userRegister, userLogin, getUserProfile, updateUserProfile, userChangePassword, uploadAvatar } from '../controllers/authController.js';
...
router.put('/user/change-password', protectUser, userChangePassword);
